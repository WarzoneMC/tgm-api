...
import { MinecraftDeathModel, MinecraftUserModel } from "../../models/minecraft";
...
router.get('/mc/death/latest', function(req, res) {
    MinecraftDeathModel
        .find({})
        .sort('-date')
        .limit(4)
 ...
 * body: Death.java
 */
router.post('/mc/death/new', verifyServer, function(req, res) {
    ...
    if(req.body.map) { //rare cases when the map wasn't loaded.
        ...
        var death = new MinecraftDeathModel({
